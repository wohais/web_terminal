...
<html>
	...
	<body>
		...
		<div class="contain pull-left">
			<form action="StockSearch_output.jsp" class="form-inline ">
				<h2>出库订单管理</h2>
			...
			<a href="Addstock_output.jsp" target="_self"><button class="btn btn-primary add">添加出库订单信息</button></a>
			<div class="pull-left">
...
<%
	...
	String sqlQuery = "SELECT * FROM web_terminal.record_output limit "+startLine+","+pageSize;//对数据库进行伪分页读取，一次只能读10行
...
//记录数据库最后一行
		while(rs.next()){
			...
			out.print("<td><a href='Alterstock_output.jsp?id="+rs.getString(1)+"'><button class='btn btn-primary'>修改</button></a><a href='Delete_output.jsp?id="+rs.getString(1)+"' onclick='javascript:return del();'><button class='btn btn-danger'>删除</button></a></td>");
			out.print("</tr>");
		}
		con.close();
...
%>
				...
				<div class="pageNav">
					...
					%>
					<li class="page-item"><a class="page-link" href="outstock.jsp?pages=<%=nextPage%>">下一页</a></li>
					</ul>
				</div>
