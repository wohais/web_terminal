...
<html>
	...
	<%
		...
		if(rs.next()){
			...
			input_num = rs.getString(4);
			input_time = rs.getString(5);
			make_time = rs.getString(6);
			expiration_data = rs.getString(7);
		}
		rs.close();
		sql.close();
		con.close();
		%>
		<div class="contain">
			<form action="Alterstock_inputTo.jsp?sourceId='<%=sourceId %>'" method="post">
