...
<div class="container">
  <h2>管理员账户密码修改</h2>
  <form action="AdminPasswordResetTo.jsp" method="post">
    <div class="form-group">
      <label for="user">用户名</label>
      <input type="text" class="form-control" id="user" name="user"  readonly="readonly" value="<%= session.getAttribute("user")%>">
    </div>
    <div class="form-group">
