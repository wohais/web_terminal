		...
		<div class="contain pull-left">
			<form action="Search.jsp" class="form-inline ">
				...
				<div class="form-group search">
					<input type="text" name="check" class="form-control" placeholder="请输入查询的商品编号或名称" />
					<input type="submit" name="submit" class="btn" value="搜索" />

				</div>
			</form>
			<a href="Addgood.jsp" target="_self"><button class="btn btn-primary add">添加货物信息</button></a>
			<div class="pull-left">
...
<%
	...
	String sqlQuery = "SELECT * FROM web_terminal.goods limit "+startLine+","+pageSize;//对数据库进行伪分页读取，一次只能读10行
